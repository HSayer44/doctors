...
}) : _doctorRepository = doctorRepository, super(const DoctorDetailsState()) {
    on<LoadDoctorDetailsEvent>(_onLoadDoctorDetails);
  }

  void _onLoadDoctorDetails(LoadDoctorDetailsEvent event, Emitter<DoctorDetailsState> emit) async {
